...
>>>>または、秘密鍵を持たないBのアドレスにAのアドレスからコインを送るためには、Proof of Burn (PoB)が求められることがあります。
